...
PrEvent <- function(HR, a.length, f.length, dist = c("exponential", "weibull", "non-parametric"),
                    lambda = NULL, shape = NULL, survfit.ref = NULL, alloc.ratio = 1, method = c("exact", "approx")) {
